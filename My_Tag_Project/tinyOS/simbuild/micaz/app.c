...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0x7f6dd2f10cf8, const void *arg_0x7f6dd2f0f020);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0x7f6dd2e8f618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x7f6dd2c46020), 
int (*key_eq_fn)(void *arg_0x7f6dd2c46798, void *arg_0x7f6dd2c46a38));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x7f6dd2a42610, int arg_0x7f6dd2a42878);
static double RandomUniform(void );
...
#line 54
Cache SRTreeC__array[1000][MAXIMUM_CHILDREN];
int SRTreeC__counter[1000];
...
uint16_t SRTreeC__old_sum[1000];
uint16_t SRTreeC__old_product[1000];
uint16_t SRTreeC__old_children[1000];
...
#line 96
  TossimPacketModelC__startDoneTask = 5U
};
#line 96
...
#line 101
  TossimPacketModelC__stopDoneTask = 6U
};
#line 101
...
#line 145
  TossimPacketModelC__sendDoneTask = 7U
};
#line 145
...
#line 81
  ...
  if (isFull) 
    {
      sim_log_debug(255U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
static inline message_t *SRTreeC__RoutingReceive__receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  sim_log_debug(92U, "SRTreeC", "### RoutingReceive.receive() start ##### \n");
  sim_log_debug(93U, "SRTreeC", "Something received!!!  from %u  %u \n", __nesc_ntoh_uint16(((RoutingMsg *)payload)->senderID.nxdata), msource);
...
#line 798
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(94U, "SRTreeC", "RoutingMsg enqueue failed!!! \n");
    }




  sim_log_debug(95U, "SRTreeC", "### RoutingReceive.receive() end ##### \n");
  return msg;
}
...
static inline message_t *SRTreeC__NotifyReceive__receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  sim_log_debug(62U, "SRTreeC", "### NotifyReceive.receive() start ##### \n");
  sim_log_debug(63U, "SRTreeC", "Something received!!!  from %u   %u \n", __nesc_ntoh_uint16(((AggrMessage *)payload)->senderID.nxdata), msource);
...
#line 320
  ...
  if (enqueueDone == SUCCESS) 
    ...
    {
      sim_log_debug(64U, "SRTreeC", "NotifyMsg enqueue failed!!! \n");
    }

  sim_log_debug(65U, "SRTreeC", "### NotifyReceive.receive() end ##### \n");
  return msg;
}
...
# 78 "/home/flogothetis/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x7f6dd260a908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x7f6dd260a908) {
#line 78
    case 12:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0x7f6dd260a908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/home/flogothetis/local/src/tinyos-2x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x7f6dd2609480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x7f6dd2609480, msg, payload, len);
#line 78
...
#line 118
  ...
  if (isEmpty) 
    {
      sim_log_debug(253U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 141
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(254U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__sendRoutingTask__runTask(void )
{
  ...
  if (SRTreeC__RoutingSendQueue__empty()) 
    {
      sim_log_debug(85U, "SRTreeC", "sendRoutingTask(): Q is empty!\n");
  ...
  if (SRTreeC__RoutingSendBusy[sim_node()]) 
    {
      sim_log_debug(86U, "SRTreeC", "sendRoutingTask(): RoutingSendBusy= TRUE!!!\n");
  ...
  if (mlen != sizeof(RoutingMsg )) 
    {
      sim_log_debug(87U, "SRTreeC", "\t\tsendRoutingTask(): Unknown message!!!\n");
  ...
  if (sendDone == SUCCESS) 
    {
      sim_log_debug(88U, "SRTreeC", "sendRoutingTask(): Send returned success!!!\n");
...
#line 118
  ...
  if (isEmpty) 
    {
      sim_log_debug(261U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 141
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(262U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__sendNotifyTask__runTask(void )
{
  ...
  if (SRTreeC__NotifySendQueue__empty()) 
    {
      sim_log_debug(55U, "SRTreeC", "sendNotifyTask(): Q is empty!\n");
  ...
  if (mlen != sizeof(AggrMessage )) 
    {
      sim_log_debug(56U, "SRTreeC", "\t\t sendNotifyTask(): Unknown message!!\n");
      return;
    }

  sim_log_debug(57U, "SRTreeC", " sendNotifyTask(): mlen = %u  senderID= %u \n", mlen, __nesc_ntoh_uint16(mpayload->senderID.nxdata));
  ...
  if (sendDone == SUCCESS) 
    {
      sim_log_debug(58U, "SRTreeC", "sendNotifyTask(): Send returned success!!!\n");
...
#line 118
  ...
  if (isEmpty) 
    {
      sim_log_debug(257U, "PacketQueueC", "dequeue(): Q is emtpy!!!!\n");
...
#line 141
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(258U, "PacketQueueC", "dequeue(): Dequeued from pos = %u \n", tmp);
...
static inline void SRTreeC__receiveRoutingTask__runTask(void )
{
  ...
  sim_log_debug(96U, "SRTreeC", "ReceiveRoutingTask(): len=%u \n", len);
      ...
      if (SRTreeC__parentID[sim_node()] < 0 || SRTreeC__parentID[sim_node()] >= 65535) 
        {
          ...
          SRTreeC__AggrTimer__startOneShot(ROUTING_TIME - PROCCESSING_TIME * (SRTreeC__curdepth[sim_node()] + 1) + (MAXIMUM_SENSORS - SRTreeC__curdepth[sim_node()]) * PROCCESSING_TIME + rand() % 80);
        }
    }
}
...
static inline void SRTreeC__receiveNotifyTask__runTask(void )
{
  ...
  sim_log_debug(66U, "SRTreeC", "ReceiveNotifyTask(): len=%u \n", len);
  ...
  if (len == sizeof(AggrMessage )) 
    {
      ...
      sim_log_debug(67U, "SRTreeC", "AggrMessage received from %d with product %d !!! \n", __nesc_ntoh_uint16(mr->senderID.nxdata));
      if (__nesc_ntoh_uint16(mr->parentID.nxdata) == TOS_NODE_ID) 
        {

          for (i = 0; i < SRTreeC__counter[sim_node()]; i++) 
            {
              if (__nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].senderID.nxdata) == __nesc_ntoh_uint16(mr->senderID.nxdata)) 
                {

                  sim_log_debug(68U, "SRTreeC", "\n\n\n\*****\n Akousa %d\n\n", __nesc_ntoh_uint16(mr->senderID.nxdata));
                  __nesc_hton_uint16(SRTreeC__array[sim_node()][i].sum.nxdata, __nesc_ntoh_uint16(mr->sum.nxdata));
                  __nesc_hton_uint16(SRTreeC__array[sim_node()][i].product.nxdata, __nesc_ntoh_uint16(mr->product.nxdata));
                  __nesc_hton_uint8(SRTreeC__array[sim_node()][i].success.nxdata, 1);
                  __nesc_hton_uint16(SRTreeC__array[sim_node()][i].children.nxdata, __nesc_ntoh_uint16(mr->children.nxdata));
                  break;
                }
            }

          if (i == SRTreeC__counter[sim_node()]) 
            {
              __nesc_hton_uint16(SRTreeC__array[sim_node()][SRTreeC__counter[sim_node()]].senderID.nxdata, __nesc_ntoh_uint16(mr->senderID.nxdata));
              __nesc_hton_uint16(SRTreeC__array[sim_node()][SRTreeC__counter[sim_node()]].sum.nxdata, __nesc_ntoh_uint16(mr->sum.nxdata));
              __nesc_hton_uint16(SRTreeC__array[sim_node()][SRTreeC__counter[sim_node()]].product.nxdata, __nesc_ntoh_uint16(mr->product.nxdata));
              __nesc_hton_uint8(SRTreeC__array[sim_node()][SRTreeC__counter[sim_node()]].success.nxdata, 1);
              __nesc_hton_uint16(SRTreeC__array[sim_node()][SRTreeC__counter[sim_node()]].children.nxdata, __nesc_ntoh_uint16(mr->children.nxdata));
              SRTreeC__counter[sim_node()]++;
            }
        }
    }
  else 
    ...
    {
      sim_log_debug(69U, "SRTreeC", "receiveNotifyTask():Empty message!!! \n");
...
#line 81
  ...
  if (isFull) 
    {
      sim_log_debug(259U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
  ...
  if (TOS_NODE_ID == 0) 
    {
      ...
      for (i = 0; i < SRTreeC__counter[sim_node()]; i++) 
        {
          if (__nesc_ntoh_uint8(SRTreeC__array[sim_node()][i].success.nxdata) == 1) 
            {
              SRTreeC__sum[sim_node()] += __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].sum.nxdata);
              SRTreeC__product[sim_node()] += __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].product.nxdata);
              SRTreeC__children[sim_node()] += __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].children.nxdata);
            }
          else 
            {
              SRTreeC__sum[sim_node()] += __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].old_sum.nxdata);
              SRTreeC__product[sim_node()] += __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].old_product.nxdata);
              SRTreeC__children[sim_node()] += __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].old_children.nxdata);
            }
        }
      ...
      sim_log_debug(47U, "SRTreeC", "Average of the Tree is  ----->> %f..........\n", average);
      sim_log_debug(48U, "SRTreeC", "Variance of the Tree is  ----->>   %lf..........\n", var1);
      sim_log_debug(49U, "SRTreeC", "Count of the Tree is  ----->> %d..........\n", SRTreeC__children[sim_node()]);
      sim_log_debug(50U, "SRTreeC", "\n ##################################### \n");
      sim_log_debug(51U, "SRTreeC", "#######   ROUND   %u    ############## \n", SRTreeC__roundCounter[sim_node()]);
...
#line 167
      ...
      for (i = 0; i < SRTreeC__counter[sim_node()]; i++) 
        {
          if (__nesc_ntoh_uint8(SRTreeC__array[sim_node()][i].success.nxdata) == 1) 
            {
              (__nesc_temp42 = m->sum.nxdata, __nesc_hton_uint16(__nesc_temp42, __nesc_ntoh_uint16(__nesc_temp42) + __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].sum.nxdata)));
              (__nesc_temp43 = m->product.nxdata, __nesc_hton_uint16(__nesc_temp43, __nesc_ntoh_uint16(__nesc_temp43) + __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].product.nxdata)));
              (__nesc_temp44 = m->children.nxdata, __nesc_hton_uint16(__nesc_temp44, __nesc_ntoh_uint16(__nesc_temp44) + __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].children.nxdata)));
            }
          else 
            {
              (__nesc_temp45 = m->sum.nxdata, __nesc_hton_uint16(__nesc_temp45, __nesc_ntoh_uint16(__nesc_temp45) + __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].old_sum.nxdata)));
              (__nesc_temp46 = m->product.nxdata, __nesc_hton_uint16(__nesc_temp46, __nesc_ntoh_uint16(__nesc_temp46) + __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].old_product.nxdata)));
              (__nesc_temp47 = m->children.nxdata, __nesc_hton_uint16(__nesc_temp47, __nesc_ntoh_uint16(__nesc_temp47) + __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].old_children.nxdata)));
            }
        }
      ...
      if (!(SRTreeC__old_sum[sim_node()] == __nesc_ntoh_uint16(m->sum.nxdata)) || SRTreeC__roundCounter[sim_node()] == 0) 
        {
          ...
          if (SRTreeC__NotifySendQueue__enqueue(tmp) == SUCCESS) 
            {
              sim_log_debug(54U, "SRTreeC", "AggrMessage Succefull in SendingQueue\n");
              SRTreeC__sendNotifyTask__postTask();
            }

          SRTreeC__old_sum[sim_node()] = __nesc_ntoh_uint16(m->sum.nxdata);
          SRTreeC__old_product[sim_node()] = __nesc_ntoh_uint16(m->product.nxdata);
          SRTreeC__old_children[sim_node()] = __nesc_ntoh_uint16(m->children.nxdata);
        }
    }
  ...
  for (i = 0; i < SRTreeC__counter[sim_node()]; i++) 
    {
      __nesc_hton_uint16(SRTreeC__array[sim_node()][i].old_sum.nxdata, __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].sum.nxdata));
      __nesc_hton_uint16(SRTreeC__array[sim_node()][i].old_product.nxdata, __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].product.nxdata));
      __nesc_hton_uint8(SRTreeC__array[sim_node()][i].success.nxdata, 0);
      __nesc_hton_uint16(SRTreeC__array[sim_node()][i].old_children.nxdata, __nesc_ntoh_uint16(SRTreeC__array[sim_node()][i].children.nxdata));
    }
  ...
  SRTreeC__AggrTimer__startOneShot(EPOCH_DURATION);
}
...
static inline void SRTreeC__RadioControl__startDone(error_t err)
{
  if (err == SUCCESS) 
    {
      sim_log_debug(73U, "Radio", "Radio initialized successfully!!!\n");
    ...
    {
      sim_log_debug(74U, "Radio", "Radio initialization failed! Retrying...\n");
...
static inline void SRTreeC__RadioControl__stopDone(error_t err)
{
  sim_log_debug(75U, "Radio", "Radio stopped!\n");
}
...
# 110 "/home/flogothetis/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x7f6dd260b6e8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x7f6dd260b6e8, msg, error);
#line 110
}
#line 110
...
# 100 "/home/flogothetis/local/src/tinyos-2x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x7f6dd1ef5318, message_t * msg, error_t error){
#line 100
  switch (arg_0x7f6dd1ef5318) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x7f6dd1ef5318, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/home/flogothetis/local/src/tinyos-2x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x7f6dd291c108){
#line 75
  switch (arg_0x7f6dd291c108) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x7f6dd291c108);
#line 75
      break;
#line 75
    }
...
{
  LedsP__Led0__clr();
  sim_log_debug(162U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP__Led0__get() ? "off" : "on");
#line 76
  ;
}
...
#line 67
# 80 "/home/flogothetis/local/src/tinyos-2x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x7f6dd1ef4488, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x7f6dd1ef4488, addr, msg, len);
#line 80
...
#line 81
  ...
  if (isFull) 
    {
      sim_log_debug(251U, "PacketQueueC", "enqueue(): Queue is FULL!!!\n");
...
#line 640
  sim_log_debug(76U, "SRTreeC", "RoutingMsgTimer fired!  radioBusy = %s \n", SRTreeC__RoutingSendBusy[sim_node()] ? "True" : "False");
  ...
  if (TOS_NODE_ID == 0) 
    {
      ...
      sim_log_debug(78U, "SRTreeC", "#######   ROUND   %u    ############## \n", SRTreeC__roundCounter[sim_node()]);
      sim_log_debug(79U, "SRTreeC", "#####################################\n");
...
#line 670
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(81U, "SRTreeC", "Sending RoutingMsg... \n");
  ...
  if (enqueueDone == SUCCESS) 
    {
      if (SRTreeC__RoutingSendQueue__size() == 1) 
        {
          sim_log_debug(82U, "SRTreeC", "SendTask() posted!!\n");

          SRTreeC__sendRoutingTask__postTask();
        }

      sim_log_debug(83U, "SRTreeC", "RoutingMsg enqueued successfully in SendingQueue!!!\n");
    }
  else 
...
#line 55
{
  sim_log_debug(173U, "Pins", "Setting bit %i of port %i.\n", (int )2, (int )27U);
  atm128RegFile[sim_node()][27U] |= 1 << 2;
}
...
#line 55
{
  sim_log_debug(172U, "Pins", "Setting bit %i of port %i.\n", (int )1, (int )27U);
  atm128RegFile[sim_node()][27U] |= 1 << 1;
}
...
#line 55
{
  sim_log_debug(171U, "Pins", "Setting bit %i of port %i.\n", (int )0, (int )27U);
...
# 83 "/home/flogothetis/local/src/tinyos-2x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x7f6dd1fb2da0){
#line 83
  switch (arg_0x7f6dd1fb2da0) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x7f6dd1fb2da0);
#line 83
      break;
#line 83
    }
...
static inline void SRTreeC__Boot__booted(void )
{
  ...
  if (TOS_NODE_ID == 0) 
...

    {
      ...
      sim_log_debug(72U, "Boot", "curdepth = %d  ,  parentID= %d \n", SRTreeC__curdepth[sim_node()], SRTreeC__parentID[sim_node()]);
    }
}
...
static void SRTreeC__NotifyAMSend__sendDone(message_t *msg, error_t err)
{
  sim_log_debug(60U, "SRTreeC", "A Notify package sent... %s \n", err == SUCCESS ? "True" : "False");



  sim_log_debug(61U, "SRTreeC", "Package sent %s \n", err == SUCCESS ? "True" : "False");
...
#line 493
    __nesc_atomic_end(__nesc_atomic); }
  sim_log_debug(70U, "SRTreeC", "NotifySendBusy = %s\n", state == TRUE ? "TRUE" : "FALSE");
...
static void SRTreeC__RoutingAMSend__sendDone(message_t *msg, error_t err)
{
  sim_log_debug(90U, "SRTreeC", "A Routing package sent... %s \n", err == SUCCESS ? "True" : "False");


  sim_log_debug(91U, "SRTreeC", "Package sent %s \n", err == SUCCESS ? "True" : "False");
...
{
  /* Module SRTreeC */
  if (!strcmp(varname, "SRTreeC__array"))
  {
    *addr = (uintptr_t)&SRTreeC__array[__nesc_mote];
    *size = sizeof(SRTreeC__array[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__counter"))
  {
    *addr = (uintptr_t)&SRTreeC__counter[__nesc_mote];
    *size = sizeof(SRTreeC__counter[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "SRTreeC__old_sum"))
  {
    *addr = (uintptr_t)&SRTreeC__old_sum[__nesc_mote];
    *size = sizeof(SRTreeC__old_sum[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__old_product"))
  {
    *addr = (uintptr_t)&SRTreeC__old_product[__nesc_mote];
    *size = sizeof(SRTreeC__old_product[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SRTreeC__old_children"))
  {
    *addr = (uintptr_t)&SRTreeC__old_children[__nesc_mote];
    *size = sizeof(SRTreeC__old_children[__nesc_mote]);
    return 0;
  }
...
{
  /* Module SRTreeC */
  memset((void *)&SRTreeC__array[__nesc_mote], 0, sizeof SRTreeC__array[__nesc_mote]);
  SRTreeC__counter[__nesc_mote] = 0;
  ...
  SRTreeC__old_sum[__nesc_mote] = -1;
  SRTreeC__old_product[__nesc_mote] = -1;
  SRTreeC__old_children[__nesc_mote] = -1;
